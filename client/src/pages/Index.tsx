  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Tech Stack */}
        <section className="py-20 px-4 border-t border-gray-800" aria-label="Technology stack">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 text-gray-300">
              {['Android (Termux)', 'Linux VPS', 'Raspberry Pi', 'CloudShell', 'WSL (Windows)'].map((platform) => (
                <div key={platform} className="p-4 bg-gray-800/50 rounded-lg border border-gray-700 hover:border-cyan-500/50 transition-colors">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-2">
              <div className="text-gray-500 text-sm">
                © 2025 CyberShellX - Autonomous Command Line AI Assistant
              </div>
