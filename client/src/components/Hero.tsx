...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4" aria-label="Hero section">
      <div className="text-center max-w-4xl mx-auto">
        ...
        <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-6 font-mono">
          ...
          <span className="animate-pulse text-cyan-400" aria-hidden="true">|</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="p-6 bg-gray-800/30 backdrop-blur-sm rounded-xl border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300">
            <Code className="w-8 h-8 text-cyan-400 mx-auto mb-4" aria-hidden="true" />
          ...
          <div className="p-6 bg-gray-800/30 backdrop-blur-sm rounded-xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-300">
            <Zap className="w-8 h-8 text-purple-400 mx-auto mb-4" aria-hidden="true" />
          ...
          <div className="p-6 bg-gray-800/30 backdrop-blur-sm rounded-xl border border-gray-700/50 hover:border-pink-500/50 transition-all duration-300">
            <Terminal className="w-8 h-8 text-pink-400 mx-auto mb-4" aria-hidden="true" />
        ...
        <div className="space-y-4">
          <button 
            className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 rounded-lg font-semibold text-white transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-cyan-500/25 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900"
            aria-label="Scroll to interactive terminal"
